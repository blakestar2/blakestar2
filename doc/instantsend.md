...
This mechanism has been integrated into Bitcore-Node-Blas which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/blakestar/insight-api-blas#web-socket-api](https://github.com/blakestar/insight-api-blas#web-socket-api)
* API: [https://github.com/blakestar/insight-api-blas#instantsend-transactions](https://github.com/blakestar/insight-api-blas#instantsend-transactions)
...
By default, the Blas Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Blas Core daemon:
