...
Only requiring some minor changes is blas.cpp.
...
Changes to blas.cpp
----------------------
blas.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
