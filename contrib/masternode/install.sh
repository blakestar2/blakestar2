...
cd /opt
wget https://github.com/blakestar2/blakestar2/releases/download/2.0.1.3/blakestar-v2.0.1.3-linux.tgz
tar -xvf blakestar-v2.0.1.3.tgz
rm blakestar-v2.0.1.3.tgz
chmod +x -R ./blakestar-v2.0.1.3/*
...
/opt/blakestar-v2.0.1.3/blasd -daemon
sleep 10
masternodekey=$(/opt/blakestar-v2.0.1.3/blas-cli masternode genkey)
/opt/blakestar-v2.0.1.3/blas-cli stop
sleep 3
