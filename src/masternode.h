...
static const int MASTERNODE_COLLATERAL_AMOUNT = 13750;
...
{
private:
    // critical section to blas the inner data structures
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 13750 BLAS - checking if valid masternode)
