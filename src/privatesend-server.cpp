...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Blas related functionality
...
/*
    ...
    allow endless transaction that would bloat Blas and make it unusable. To
