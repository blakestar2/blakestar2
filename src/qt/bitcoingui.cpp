    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Blas Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Blas address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blas: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Blas Core"), this);
    aboutAction->setStatusTip(tr("Show information about Blas Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Blas Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Blas addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Blas addresses"));
    ...
    openAction->setStatusTip(tr("Open a blas: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Blas Core help message to get a list with possible Blas Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Blas Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Blas network", "", count));
    } else {
...
{
    QString strTitle = tr("Blas Core"); // default title
