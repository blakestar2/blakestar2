    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Blas Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Blas Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  blas-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Blas in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BLAS, 0.1 BLAS, 1 BLAS and 10 BLAS -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Blas Core is shutting down...") + "<br /><br />" +
