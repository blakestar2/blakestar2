 ...
 *
 *   // network
 *   CBlasNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CBlasNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BlasNetwork
// //   -- signature requirements : Key1(User)
// class CBlasNetworkVariable : public CGovernanceObject
// {
// private:
